...
import torch
import numpy as np
from RHEMCLIP_lib.simple_tokenizer import SimpleTokenizer as _Tokenizer
...
class RHEMCLIP_PromptLearner(nn.Module):
    def __init__(self, clip_model, design_details):
        super().__init__()
        classnames = ["object"]
        # classnames = ["wind turbine blade"]
        ...
        print("abnormal prompt:",prompts_neg)
